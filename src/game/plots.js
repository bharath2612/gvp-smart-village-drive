...
export function describe(p, world) {
  ...
  if (p.type === 'villa') {
    ...
    const blurb = { temple: 'Stepped tower on a plinth with lawn quadrants.', school: 'Two-storey courtyard block with a playfield.', stadium: 'Open bowl with running track, stands and floodlights.', agro: 'Processing sheds, silos and loading yard.', parking: 'Surface parking for the lake district.', 'fire-station': 'Three-bay station with a drill tower.', wtp: 'Four treatment tanks and a water tower.', lake: 'The village lake. Drive in and you will be fished out onto the joggers’ track.' };
